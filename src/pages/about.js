...
import AboutImage from "../../static/misc/main/errie001W.jpg";
...
const About = () => {
    return (
        <Layout>
            ...
            <div style={{width: '50%'}}>
                ...
                <p>
                   <em>Change comes quickly to Errie's home town when she stumbles into a quarrel 
                    ...
                    who take the form of the animal they resemble.</b>
                </p>
                <p>
            ...
            <img src={AboutImage} alt="Errie and the Vines" style={{width: '50%'}} />
            </div>
        </Layout>
    );
};
